...
print('starting up credit score service')
...
def setup():
    global x_train, y_train, x_val, y_val, model, score_template, data, data_train, data_valid
...
def score(args):
    ...
    y_pred = (model.predict( x_score_args ) > 0.5).astype("int32")
